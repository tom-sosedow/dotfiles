...
complete -c lzip-decompressor -s b -l member-size -d 'set member size limit in bytes'
...
complete -c lzip-decompressor -s S -l volume-size -d 'set volume size limit in bytes'
