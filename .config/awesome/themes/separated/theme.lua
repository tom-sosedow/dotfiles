...
local function get_theme(base_theme)
    ...
    --my colors
    theme.useless_gap                               = 3
    theme.window_border_radius                      = 10
    theme.status_border_radius                      = 10
    ...
    function theme.at_screen_connect(s)
        ...
        -- put background and then margin under widgets
        local background_container = function(widgets, width) 
            return {
                {
                    {
                        {
                ...
                bg = theme.black,
                shape = function(cr,w,h) gears.shape.rounded_rect(cr,w,h,theme.status_border_radius) end,
                widget = wibox.container.background,
            }
        end
        ...
        s.mywibox:setup {
            {
                layout = wibox.layout.align.horizontal,
                {
                    ...
                    {
                        background_container(s.mytasklist),
                        left = spacing_width,
                        color = theme.transparent,
                        widget = wibox.container.margin,
                    },
                ...
                wibox.widget{},
                {
                    layout = wibox.layout.fixed.horizontal,
                    spacer,
                    background_container(wibox.container.place(wibox.widget { systray, layout = wibox.layout.align.horizontal }, "center", "center")),
                    spacer,
                    background_container(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, 3, 3)),
                    spacer,
                    background_container(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 3, 3)),
                    spacer,
                    background_container(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 3), 92),
                    spacer,
                    background_container(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, 3, 3)),
                    spacer,
                    -- background_container(wibox.container.margin(wibox.widget { neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3)),
                    -- spacer,
                    background_container(wibox.container.margin(wibox.widget { clockicon, wibox.container.margin(clock, 2, 0), layout = wibox.layout.align.horizontal }, 3, 3)),
                    spacer,
                    background_container(s.mylayoutbox),
                },
            },
